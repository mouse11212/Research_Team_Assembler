"""回填 market_emotion 20260811(不含) -> 20260812(纯库内计算, 零网络请求)

动机: market_emotion 表 20260812 单日缺行。
本脚本只读本地规范库表(stock_kline/stock_info), 复用生产计算函数落库。
模式与 data/backfill_market_emotion_20260811.py 完全一致, 仅改回填区间。
...
用法: cd src && python3 data/backfill_market_emotion_20260812.py
"""
...
START_EXCLUSIVE = "20260811"  # 回填区间: (0811, 0812]
END_DATE = "20260812"
